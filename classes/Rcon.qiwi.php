...
class RconQiwi
{
    ...
    public function privilege_pay()
    {
        ...
        $this->db->query("UPDATE `qiwipay` SET request = '" . $request . "', respond = '" . $respond . "' WHERE `billid` = " . (int)$this->pay_id);

        return ['request' => $request, 'respond' => $respond];
    }
