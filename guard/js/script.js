(function() {
	...
	var group_id = '41994665'; // id группы
	var topic_id = '31531166'; // id обсуждения
	var count = 100;
	var extended = 1; // будут ли загружены профили в отзывы (0 - нет, 1 - да)
	var need_likes = 0; // загружаем лайки (0 - не загружать, 1 - загрузить)
	var sort = 1; // фильтруем вывод комментариев (0 - с начала, 1 - с конца)
	...
	var linkToGroup = 'https://vk.com/gamenix'; // ссылка на вас или вашу группу
	var adminName = 'Администратор'; // Ваше имя или название вашей группы
	var adminIcon = 'http://gamenix.su/report/img/gamenix.png'; // URL иконки вашего vk или группы, размер 100x100
	...
	function showDiscussion(req, templateElement, commentsContainer, idStartComment) {
		...
		function validationComment(comment, data, getText, getLink) {
			...
			// [club41994665:bp-41994665_36835563|Северный Флот]
